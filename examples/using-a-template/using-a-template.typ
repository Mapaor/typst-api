// Internally Typst templates are just packages. So we only need to import them.
#import "@preview/graceful-genetics:0.2.0"

// A  package is usually designed to give your document a certain style, and it usually comes with a way to display a certain essential information or tweak some configuration using a show rule.
